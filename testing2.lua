...
local Settings = {
	...
	Themes = {
		...
		OutlineColor2 = Color3.fromRGB(60, 80, 200), -- // outline of stuff in uis (buttons, frames, etc.) : default : 45, 45, 45
		--// CmdBar
...
local NFuncs = {} --// BlueberryCmdFunctions
local PlayerFuncs = {}
local UIFuncs = {
	--// Popup
	FrameSpeed = 0.5,
...
-- Gradient text label "Bb" on button
...
-- Gradient: blue -> void -> berry purple
...
-- Squircle shape (CornerRadius 0.25 = squircle, not full circle)
UIFuncs.CreateInstance(
	"UIStroke",
	{
		Thickness = 1,
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("BlueberryCmd", "Antifling <b>enabled</b>", 5)
		repeat
			task.wait()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("BlueberryCmd", "InfJump enabled. Use ;uninfjump to stop.", 5)
	end
)
...
Command.Add(
	...
	function(Power)
		...
		UIFuncs.SendNotification("BlueberryCmd", "Touchfling <b>enabled</b>", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("BlueberryCmd", "Touchfling <b>disabled</b>", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("BlueberryCmd", "Dropping all tools in your inventory", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("BlueberryCmd", "Started grabbing & deleting tools", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("BlueberryCmd", "Stopped grabbing & deleting tools", 5)
		CommandToggles.LoopGrabDelete = false
	end
)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("BlueberryCmd", "Started grabbing tools", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("BlueberryCmd", "Stopped grabbing tools", 5)
		CommandToggles.LoopGrab = false
	end
)
...
Command.Add(
	...
	function(Number)
		...
		if not value then
			UIFuncs.SendNotification("BlueberryCmd", "Please provide a valid number!", 5)
			return
		end
		CommandToggles.LoopWalkspeed = true
		CommandToggles.LoopWalkspeedValue = value
		UIFuncs.SendNotification("BlueberryCmd", "LoopWalkspeed set to <b>" .. value .. "</b>. Use ;unlws to stop.", 5)
		spawn(function()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("BlueberryCmd", "LoopWalkspeed stopped.", 5)
	end
)
...
Command.Add(
	...
	function(Number)
		...
		UIFuncs.SendNotification("BlueberryCmd", "LoopJumpPower set to <b>" .. value .. "</b>. Use ;unljp to stop.", 5)
		spawn(function()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("BlueberryCmd", "LoopJumpPower stopped.", 5)
	end
)
Command.Add(
	{"SitFly", "SF"},
	{"SitFly / SF", "Fly while sitting using Slicer X method, harder to detect"},
	{"None"},
	function()
		if CommandToggles.SitFly then
			UIFuncs.SendNotification("BlueberryCmd", "SitFly already active. Use ;unsitfly to stop.", 4)
			return
		end
		...
		CommandToggles.SitFlyRSConn = Services.RunService.RenderStepped:Connect(function()
			...
			if lv and ao and hum then
				...
				lv.VectorVelocity = move * 50
			end
		end)

		UIFuncs.SendNotification("BlueberryCmd", "SitFly enabled. WASD to move, Space up, LShift down. Use ;unsitfly to stop.", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("BlueberryCmd", "SitFly stopped.", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		if CommandToggles.AlreadyStartedLogging == false then
			...
			UIFuncs.SendNotification("BlueberryCmd", "Started logging", 5)
			for i, Player in next, Services.Players:GetPlayers() do
				if Services.TextChatService:FindFirstChild("TextChannels") then
...
UIFuncs.SendNotification("BlueberryCmd", "BlueberryCmd loaded! Type ;cmds to see all commands.", 6)
...
Services.LocalPlayer.CharacterAdded:Connect(function(NewCharacter)
	...
	if CommandToggles.LoopWalkspeed then
		...
		UIFuncs.SendNotification("BlueberryCmd", "LoopWalkspeed re-applied after respawn (" .. CommandToggles.LoopWalkspeedValue .. ")", 4)
		spawn(function()
			while CommandToggles.LoopWalkspeed do
				Services.RunService.Heartbeat:Wait()
				pcall(function()
	...
	if CommandToggles.LoopJumpPower then
		...
		UIFuncs.SendNotification("BlueberryCmd", "LoopJumpPower re-applied after respawn (" .. CommandToggles.LoopJumpPowerValue .. ")", 4)
		spawn(function()
			while CommandToggles.LoopJumpPower do
				Services.RunService.Heartbeat:Wait()
				pcall(function()
