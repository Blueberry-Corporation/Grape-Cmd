...
Spawn(function()
	...
	-- Ketamine Admin rebrand: set open button icon
	pcall(function()
		if Button:IsA("ImageButton") then
			Button.Image = "rbxassetid://116368608257"
		elseif Button:FindFirstChildOfClass("ImageLabel") then
			Button:FindFirstChildOfClass("ImageLabel").Image = "rbxassetid://116368608257"
		end
	end)
...
API:Notify({
	Title = "Welcome to Ketamine Admin",
	Description = Format(
