...
local Settings = {
	...
	Themes = {
		--// Gui
		PrimaryBGColor = Color3.fromRGB(28, 18, 40), -- // default : 25,25,25
		TopbarColor = Color3.fromRGB(40, 24, 58), -- // default : 26,26,26
		...
		OutlineColor2 = Color3.fromRGB(90, 40, 130), -- // outline of stuff in uis (buttons, frames, etc.) : default : 45, 45, 45
		--// CmdBar
		CommandLinesColor = Color3.fromRGB(28, 18, 40),
		CommandCenterBarColor = Color3.fromRGB(28, 18, 40),
		EdgeColor = Color3.fromRGB(28, 18, 40),
		AutofillColor = Color3.fromRGB(28, 18, 40),
...
if getgenv then
	if getgenv().GrapeLoaded then
		getgenv().GrapeInterfacePath.Parent = nil
...
if Checks.CheckIfFolderFuncs then
	if not isfolder("Grape-Admin-V1") then
		makefolder("Grape-Admin-V1")
	end

	if not isfolder("Grape-Admin-V1/Plugins") then
		makefolder("Grape-Admin-V1/Plugins")
	end

	if not isfolder("Grape-Admin-V1/Waypoints") then
		makefolder("Grape-Admin-V1/Waypoints")
	end

	if not isfolder("Grape-Admin-V1/KeyBinds") then
		makefolder("Grape-Admin-V1/KeyBinds")
	end
end
...
UIFuncs.CreateInstance(
	"ImageLabel",
	{
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://128028916343166",
...
spawn(
	function()
		...
		if Start:FindFirstChild("Title") then Start.Title.Text = "Grape Admin" end
		...
		UIFuncs.TypeWriter(Description, "Grape Admin is loading...")
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "Successfully unlocked every part in the game", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "Anti kick loaded", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "Anti teleport loaded", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		if Tool.Parent ~= workspace then
			...
			UIFuncs.SendNotification("Grape Admin", "No tool grabber was found", 5)
		end
...
Command.Add(
	...
	function(Username)
		if not Services.SoundService.RespectFilteringEnabled then
			...
			UIFuncs.SendNotification('Grape Admin', 'Respect Filtering Enabled is on, so this command wont work.', 5)
		end
	end
)
...
Command.Add(
	...
	function(Property, Value)
		if Property and Value then
			...
			UIFuncs.SendNotification("Grape Admin", "Missing an argument", 5)
		end
	end
)
...
Command.Add(
	...
	function()
				...
				Plr.Chatted:Connect(
					function(Message)
						if CheckIfMessageHasBannedWord(Message) then
							...
							UIFuncs.SendNotification("Grape Admin", "Reported " .. Plr.Name .. " for " .. Reason, 5)
		...
		UIFuncs.SendNotification("Grape Admin", "Auto report has loaded!", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		if fireclickdetector then
			...
			UIFuncs.SendNotification("Grape Admin", "Fired " .. tostring(Amount) .. " click detectors", 5)
		else
			UIFuncs.SendNotification("Grape Admin", "Your exploit doesnt support this command", 5)
		end
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "Antifling <b>enabled</b>", 5)
		repeat
			task.wait()
...
Command.Add(
	...
	function()
		...
		if firetouchinterest then
			...
			UIFuncs.SendNotification("Grape Admin", "Fired " .. tostring(Amount) .. " touch interests", 5)
		else
			UIFuncs.SendNotification("Grape Admin", "Your exploit doesnt support this command", 5)
		end
	end
...
Command.Add(
	...
	function()
		...
		if fireproximityprompt then
			...
			UIFuncs.SendNotification("Grape Admin", "Fired " .. tostring(Amount) .. " proximity prompts", 5)
		else
			UIFuncs.SendNotification("Grape Admin", "Your exploit doesnt support this command", 5)
		end
	end
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "Fired " .. tostring(Amount) .. " remotes", 5)
	end
)
...
Command.Add(
	...
	function(Gravity)
		...
		UIFuncs.SendNotification("Grape Admin", "Set gravity for unanchored parts to " .. tostring(Gravity), 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "InfJump enabled. Use ;uninfjump to stop.", 5)
	end
)
...
Command.Add(
	...
	function(...)
		for i, Player in next, PlayerFuncs.GetPlayer(...) do
			if Player.Character and Player.Character.Humanoid then
				UIFuncs.SendNotification("Grape Admin", "Viewing @" .. Player.Name, 5)
...
Command.Add(
	{"Prefix", "Pre"},
	{"Prefix / Pre", "Changes the prefix of Grape Admin"},
	{"Prefix"},
	function(Prefix)
...
Command.Add(
	...
	function(Power)
		...
		UIFuncs.SendNotification("Grape Admin", "Touchfling <b>enabled</b>", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", "Touchfling <b>disabled</b>", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", "Dropping all tools in your inventory", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", "Started grabbing & deleting tools", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", "Stopped grabbing & deleting tools", 5)
		CommandToggles.LoopGrabDelete = false
	end
)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", "Started grabbing tools", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", "Stopped grabbing tools", 5)
		CommandToggles.LoopGrab = false
	end
)
...
Command.Add(
	...
	function(Number)
		...
		if not value then
			UIFuncs.SendNotification("Grape Admin", "Please provide a valid number!", 5)
			return
		end
		CommandToggles.LoopWalkspeed = true
		CommandToggles.LoopWalkspeedValue = value
		UIFuncs.SendNotification("Grape Admin", "LoopWalkspeed set to <b>" .. value .. "</b>. Use ;unlws to stop.", 5)
		spawn(function()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "LoopWalkspeed stopped.", 5)
	end
)
...
Command.Add(
	...
	function(Number)
		...
		UIFuncs.SendNotification("Grape Admin", "LoopJumpPower set to <b>" .. value .. "</b>. Use ;unljp to stop.", 5)
		spawn(function()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "LoopJumpPower stopped.", 5)
	end
)
Command.Add(
	{"SitFly", "SF"},
	...
	function()
		if CommandToggles.SitFly then
			UIFuncs.SendNotification("Grape Admin", "SitFly already active. Use ;unsitfly to stop.", 4)
			return
		end
		...
		UIFuncs.SendNotification("Grape Admin", "SitFly enabled. WASD to move, Space up, LShift down. Use ;unsitfly to stop.", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Grape Admin", "SitFly stopped.", 5)
	end
)
...
Command.Add(
	{"CommandCount", "CC"},
	{"CommandCount / CC", "Tells the amount of commands Grape Admin has"},
	{"None"},
	function()
		UIFuncs.SendNotification("Grape Admin", tostring(CommandAmount), 5)
	end
)
...
Command.Add(
	{"Admin", "A"},
	{"Admin / A", "Gives another user access to use Grape Admin commands without having it ran"},
	{"Username"},
	function(Username)
		...
		for i, Plr in next, Player do
			if not Settings.Admins[Plr.UserId] then
				...
				UIFuncs.SendNotification("Grape Admin", "Succcessfully gave <b>" .. Plr.Name .. "</b> admin!", 5)
				PlayerFuncs.Chat("/w " .. Plr.Name .. " [NA] You are now an admin")
			else
				UIFuncs.SendNotification("Grape Admin", "This user seems to already be an admin", 5)
			end
		end
	end
)
	...
	function(Username)
		...
		for i, Plr in next, Player do
			if Settings.Admins[Plr.UserId] then
				...
				UIFuncs.SendNotification("Grape Admin", "Succcessfully removed <b>" .. Plr.Name .. "'s</b> admin", 5)
				PlayerFuncs.Chat("/w " .. Plr.Name .. " [NA] You are no longer an admin")
			else
				UIFuncs.SendNotification("Grape Admin", "The user <b>" .. Plr.Name .. "</b> isn't an admin", 5)
			end
		end
	end
)
...
Command.Add(
	{"Introduction", "Int"},
	{"Introduction / Int", "An introduction to Grape Admin if you haven't read it yet"},
	{"None"},
	function()
		wait(0.3)
...
Command.Add(
	...
	function()
		...
		if CommandToggles.AlreadyStartedLogging == false then
			...
			UIFuncs.SendNotification("Grape Admin", "Started logging", 5)
			for i, Player in next, Services.Players:GetPlayers() do
				if Services.TextChatService:FindFirstChild("TextChannels") then
...
Command.Add(
	...
	{"Settings / Options / Set / Opt", "Opens the Options tab, allows you to change things about Grape Admin"},
	{"None"},
	function()
		local Popup = UIFuncs
...
if Methods.CheckIfVulnerable() then
	...
	UIFuncs.SendNotification(
		"Grape Admin",
		"Seems like this game has an remote that is vulnerable to attacks using Grape Admin, you have been given extra commands run <b>cmds</b> and look for commands that have '(Vuln)' next to them, to see what new commands you now have.",
		15
	)
...
UIFuncs.SendNotification("Grape Admin", "Grape Admin has loaded", 5)
...
UIFuncs.PopupTrigger(
	"Grape Admin",
	"Seems like you are new here, would you like a tutorial on how to use Grape Admin?",
	function()
		wait(0.3)
		UIFuncs.Open(Interface.Introduction, 317, 283, 0.6)
		Interface.Introduction.Description.TextTransparency = 1
...
if getgenv then
	getgenv().GrapeLoaded = true
	getgenv().GrapeInterfacePath = Interface
...
-- Grape Admin: auto re-apply LoopWalkspeed & LoopJumpPower on respawn/death
Services.LocalPlayer.CharacterAdded:Connect(function(NewCharacter)
	...
	if CommandToggles.LoopWalkspeed then
		...
		UIFuncs.SendNotification("Grape Admin", "LoopWalkspeed re-applied after respawn (" .. CommandToggles.LoopWalkspeedValue .. ")", 4)
		spawn(function()
			while CommandToggles.LoopWalkspeed do
				Services.RunService.Heartbeat:Wait()
				pcall(function()
	...
	if CommandToggles.LoopJumpPower then
		...
		UIFuncs.SendNotification("Grape Admin", "LoopJumpPower re-applied after respawn (" .. CommandToggles.LoopJumpPowerValue .. ")", 4)
		spawn(function()
			while CommandToggles.LoopJumpPower do
				Services.RunService.Heartbeat:Wait()
				pcall(function()
